...
public interface BatchedBlockingQueue<T> extends BlockingQueue<T> {
    ...
    /**
     * Drain the queue into an array. Wait if there are no items in the queue.
     *
     * @param array
     * @return
     ...
     *
     * <p>The method returns when either: 1. At least one item is available 2. The timeout expires
     *
     * @param array
     * @param timeout
     * @param unit
