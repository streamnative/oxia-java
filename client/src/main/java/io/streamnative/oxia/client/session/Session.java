...
public class Session implements AutoCloseable {
    ...
    Session(
        ...
        this(
                ...
                metrics,
                listener);
        log.info("Session created shard={} sessionId={} clientIdentity={}", shardId, sessionId,
                config.clientIdentifier());
    ...
    private void handleSessionExpired(Throwable t) {
        log.warn("Session expired shard={} sessionId={} clientIdentity={}: {}", shardId, sessionId, clientIdentifier,
                t.getMessage());
        close();
    }
    ...
    public void close() {
        ...
        var request = CloseSessionRequest.newBuilder()
                .setShardId(shardId)
        ...
        try {
            ...
            log.info("Session closed shard={} sessionId={} clientIdentity={}", shardId, sessionId, clientIdentifier);
        } catch (Exception e) {
